...
\begin{tightemize}
	\item \itemdescript{Customer-service focused, ensured that guests had a high quality dining experience}
	\item \itemdescript{Worked collaboratively with other employees in a team-driven environment}
\end{tightemize}
\sectionsep
...
\project{Secure Client-Server Network}{Oct 2019 --- December 2019}
\begin{tightemize}
	\item \itemdescript{Secure file transfer using \textbf{TCP} in terms of authentication, integrity and confidentiality}
	\item \itemdescript{Implemented using \textbf{RSA public} and \textbf{private keys}, \textbf{XOR} operation and \textbf{hashing} in python}
\end{tightemize}
