...
\sectionsep
\begin{tightemize}
	\item \itemdescript{Create automation scripts for cloud-based \textbf{ETL} pipelines using \textbf{AWS} services and \textbf{airflow}. One project involves survey data landing in an S3 bucket which will trigger a Lambda function that starts an airflow DAG. Another would be creating a docker image containing scripts that performs machine learning training and prediction process using AWS SageMaker and Kubernetes pods}
